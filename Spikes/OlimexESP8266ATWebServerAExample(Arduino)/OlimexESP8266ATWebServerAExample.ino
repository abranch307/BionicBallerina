...
const char* ssid = "Samsung GALAXY Note4 2252";
const char* password = "ugaf9857";

MDNSResponder mdns;
const char* ssidSoft = "SeniorDesignOlimex";
const char* passphraseSoft = "BUBBLES";
